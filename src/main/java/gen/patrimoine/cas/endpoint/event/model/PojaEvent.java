package gen.patrimoine.cas.endpoint.event.model;

import static gen.patrimoine.cas.endpoint.event.EventStack.EVENT_STACK_1;
import static java.lang.Math.random;

import gen.patrimoine.cas.PojaGenerated;
import gen.patrimoine.cas.endpoint.event.EventStack;
...
public abstract class PojaEvent implements Serializable {
  ...
  public String getEventSource() {
    if (getEventStack().equals(EVENT_STACK_1)) return "gen.patrimoine.cas.event1";
    return "gen.patrimoine.cas.event2";
  }
}
