package gen.patrimoine.cas.endpoint.event.consumer;

import gen.patrimoine.cas.PojaGenerated;
import gen.patrimoine.cas.endpoint.event.consumer.model.TypedEvent;
...
public class EventServiceInvoker implements Consumer<TypedEvent> {
  ...
  public void accept(TypedEvent typedEvent) {
    ...
    var eventClasses = getAllClasses("gen.patrimoine.cas.endpoint.event.model");
  ...
  private String getEventService(String eventClazzName) {
    ...
    return "gen.patrimoine.cas.service.event."
