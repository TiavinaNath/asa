package gen.patrimoine.cas.endpoint.rest.controller.health;

import static gen.patrimoine.cas.file.hash.FileHashAlgorithm.NONE;
import static java.io.File.createTempFile;
import static java.nio.file.Files.createTempDirectory;
import static java.util.UUID.randomUUID;

import gen.patrimoine.cas.PojaGenerated;
import gen.patrimoine.cas.file.bucket.BucketComponent;
import gen.patrimoine.cas.file.hash.FileHash;
import java.io.File;
